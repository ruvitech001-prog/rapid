...
export default function LoginPage() {
  ...
  const handleMicrosoftSignIn = () => {
    // TODO: Implement real Microsoft OAuth sign-in
    setError('Microsoft sign-in coming soon. Please use email/password login.');
  };

  const handleLinkedInSignIn = () => {
    // TODO: Implement real LinkedIn OAuth sign-in
    setError('LinkedIn sign-in coming soon. Please use email/password login.');
  };
  ...
  return (
    <AuthLayout>
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Welcome to Rapid</h1>
        <p className="text-gray-500">
          To log in, you can either continue with Google, Microsoft, or LinkedIn, or your email address.
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <button
          ...
          disabled={loading}
          className="h-12 flex items-center justify-center gap-2 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors"
